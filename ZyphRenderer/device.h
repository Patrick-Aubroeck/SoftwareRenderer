...
private:
	...
	void DrawDDALine(ZyphMaths::Vector2 point0, ZyphMaths::Vector2 point1); // Draws a line on the screen using the digital differential analyzer algorithm.
	void DrawWuLine(ZyphMaths::Vector2 point0, ZyphMaths::Vector2 point1); // Draws a line on the screen using the Xiaolin Wu line algorithm.
